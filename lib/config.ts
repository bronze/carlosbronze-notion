...
export const bluesky: string | null = getSiteConfig('bluesky', null)
export const onlyfans: string | null = getSiteConfig('onlyfans', null)
export const resume: string | null = getSiteConfig('resume', null)
...
export const amplitudeId = process.env.NEXT_PUBLIC_AMPLITUDE_ID
export const amplitudeConfig = amplitudeId
  ? {
